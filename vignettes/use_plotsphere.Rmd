...
Connecting the two Cities we the sf package creates by default a shortest great circle segment on the sphere. We can display the length by summary of the geoairline class object and plot it on a sphere by default
```{r geoairline}
