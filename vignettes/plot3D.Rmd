...
* `snapshot3d`: Saves a snapshot from the current rgl window
...
To demonstrate those functions we plot a very primitive globe here! Note that our sphere here has the poles at the equators and edges along its surface. Therefore, using `ps_globe()` later on will create a nicer globe.
